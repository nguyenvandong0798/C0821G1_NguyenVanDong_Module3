...
CREATE TABLE `mark` (
  ...
  PRIMARY KEY (`mark_id`),
  UNIQUE KEY `subject_id` (`subject_id`,`student_id`),
  KEY `student_id` (`student_id`),
  CONSTRAINT `mark_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`),
  CONSTRAINT `mark_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`subjects_id`),
...
CREATE TABLE `subjects` (
  ...
  CONSTRAINT `subjects_chk_1` CHECK ((`credit` >= 1))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-15 14:36:16
